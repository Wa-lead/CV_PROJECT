...
class Chemception_wroker(Worker):
    ...
    def __init__(self, sleep_interval=0, **kwargs):
        super().__init__(run_id=np.random.randint(10000),**kwargs)
    ...
    def compute(self, config, budget, **kwargs):
        ...
        X_train, y_train = self._format_data(self.train_df)
        X_val, y_val = self._format_data(self.val_df)
